...
public abstract class LocationProviderClient implements ILocationProvider {
     ...
     */
    protected void checkPermissionGranted(Context context) throws NoLocationAccessException {
     ...
     * @throws IntervalValueOutOfRangeException Exception is thrown when input value is less than {@link LocationProvider#MINIMUM_UPDATE_INTERVAL}.
     */
